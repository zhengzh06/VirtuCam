...
import com.wangyiheng.VirtuCam.utils.OutputImageFormat
import com.wangyiheng.VirtuCam.utils.VideoPlayer.c1_camera_play
import com.wangyiheng.VirtuCam.utils.VideoPlayer.camera2Play
import com.wangyiheng.VirtuCam.utils.VideoPlayer.ijkMediaPlayer
import com.wangyiheng.VirtuCam.utils.VideoPlayer.initializeTheStateAsWellAsThePlayer
import com.wangyiheng.VirtuCam.utils.VideoToFrames
...
class MainHook : IXposedHookLoadPackage {
    ...
    override fun handleLoadPackage(lpparam: XC_LoadPackage.LoadPackageParam) {
        if(lpparam.packageName == "com.wangyiheng.VirtuCam"){
            return
        }
...
//            return
//        }
        Log.d("MH_ADEBUG", "HANDLE LOAD PACKAGE.")
        //获取context
            ...
            Camera::class.java, object : XC_MethodHook() {
                ...
                override fun beforeHookedMethod(paramd: MethodHookParam) {
                    ...
                    if (localcam ==  camera_onPreviewFrame) {
                        ...
                        while ( data_buffer == null) {
                            Log.d("MAINHOOK_ADEBUG", "DATABUFFER IS NULL")
                        }
                        Log.d("MAINHOOK_ADEBUG", "DATABUFFER FULL")
                        System.arraycopy(data_buffer, 0, paramd.args[0], 0, min(data_buffer.size.toDouble(), (paramd.args[0] as ByteArray).size.toDouble()).toInt())
                    }
                }
            })
